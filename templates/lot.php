            ...
            <div class="lot-item__content">
                <div class="lot-item__left">
                    <div class="lot-item__image">
                        <img src="/uploads/<?= isset($lot['picture'])
                          ? $lot['picture'] : '' ?>" width="730" height="548"
                             alt="Сноуборд">
                    </div>
                    <p class="lot-item__category">Категория:
                        <span><?= isset($lot['cathegory'])
                              ? esc($lot['cathegory']) : '' ?></span></p>
                    <p class="lot-item__description">
                        <?= isset($lot['description'])
                          ? esc($lot['description']) : '' ?>
                    </p>
                </div>
                <div class="lot-item__right">
                    <div class="lot-item__state">
                        <div class="lot-item__timer timer <?= isset($lot['end_date'])
                          ? get_class_finishing($lot['end_date']) : '' ?>">
                            <?= isset($lot['end_date'])
                              ? get_timer_lelt($lot['end_date'], true) : '' ?>
                        </div>
                          ...
                          && isset($lot['user_id'])
                            ...
                            <?php if ($user_id !== $lot['user_id']) : ?>
                                <form class="lot-item__form" action="lot.php"
                                    ...
                                    <p class="lot-item__form-item form__item <?= (isset($errors['staf']))
                                      ? 'form__item--invalid' : '' ?>">
                                        ...
                                        <input id="cost" type="text" name="cost"
                                               placeholder="<?= amount_format($min_rate) ?>">
