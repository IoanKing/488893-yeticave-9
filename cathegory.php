<?php
  ...
  $cath_name = db_fetch_data($DB, isset($query_template['cathegory_name_by_id']) ? $query_template['cathegory_name_by_id'] : '', $cathegory_id);
  ...
  $count_adverts = db_fetch_data($DB, isset($query_template['lot_by_cathegory_count']) ? $query_template['lot_by_cathegory_count'] : '', $cathegory_id);
  ...
  if (isset($count_adverts[0]['count'])) {
    ...
    if ($count_adverts[0]['count'] > 0) {
      ...
      $adverts = db_fetch_data($DB, isset($query_template['lot_by_cathegory']) ? $query_template['lot_by_cathegory'] : '', [$cathegory_id, $limit_per_page, $offset]);
