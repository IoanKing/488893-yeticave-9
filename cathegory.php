<?php
  ...
  $cath_name = db_fetch_data($DB, $query_template['cathegory_name_by_id'], $cathegory_id);
  ...
  $count_adverts = db_fetch_data($DB, $query_template['lot_by_cathegory_count'], $cathegory_id);
  ...
  if ($count_adverts[0]['count'] > 0) {
    ...
    $adverts = db_fetch_data($DB, $query_template['lot_by_cathegory'], [$cathegory_id, $limit_per_page, $offset]);
